...
go_repository(
    ...
    sum = "h1:13AfxzFoPlFjOzXHbRnKuTbteCzHbu4YQgKONNhWcmo=",
    version = "v1.18.0",
)
...
go_repository(
    ...
    sum = "h1:vngPRchZs603qLtJH7lh2pBCDqiFxA9+9nDWJ5WYJ5A=",
    version = "v1.33.17",
)
...
go_repository(
    name = "com_github_bold_commerce_go_shopify_v3",
    importpath = "github.com/bold-commerce/go-shopify/v3",
    sum = "h1:978ybIV7Vt1xTGcOOWwu73GmKFqKGWj7d763utLKmGE=",
    version = "v3.6.0",
)
...
go_repository(
    name = "com_github_fnproject_fdk_go",
    importpath = "github.com/fnproject/fdk-go",
    sum = "h1:nebofQYAY8SbcjqmoaBo6KLNTwUrJq6lGdi7RCbq/EA=",
    version = "v0.0.2",
)
...
go_repository(
    name = "com_github_guregu_dynamo",
    importpath = "github.com/guregu/dynamo",
    sum = "h1:hZhM+O4Wi0EIIptgLqUHf6Nxfx4wogdBvzyjl7pUBFY=",
    version = "v1.8.0",
)
...
go_repository(
    name = "com_github_line_line_bot_sdk_go",
    importpath = "github.com/line/line-bot-sdk-go",
    sum = "h1:uuOUOhDMxSMgfRuv6pPJ3klxEMEWO2FEJptZloNHUM0=",
    version = "v7.5.0+incompatible",
)
...
go_repository(
    name = "com_github_mroth_weightedrand",
    importpath = "github.com/mroth/weightedrand",
    sum = "h1:8dllRVd5Y1jIJsigUpQaL5DUlV4qBiM+SF82d+cMwew=",
    version = "v0.3.0",
)
...
go_repository(
    name = "com_github_tencentyun_scf_go_lib",
    importpath = "github.com/tencentyun/scf-go-lib",
    sum = "h1:xp/21gmSPTeWIkalsgXw2njIh3zZyrRRcuCgQfOPLLU=",
    version = "v0.0.0-20200116145541-9a6ea1bf75b8",
)
