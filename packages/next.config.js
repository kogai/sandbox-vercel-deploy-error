...
module.exports = {
  ...
  serverRuntimeConfig: {
    shopify: {
      apiSecret: process.env.SHOPIFY_STOREFRONT_API_EXPLORER_API_SECRET,
    },
  },
  publicRuntimeConfig: {
    shopify: {
      apiKey: process.env.SHOPIFY_STOREFRONT_API_EXPLORER_API_KEY,
      appURL:
    ...
    sentry: {
      dns:
        'https://8c78d0a465114c7984c34a77f185a796@o413702.ingest.sentry.io/5381010',
